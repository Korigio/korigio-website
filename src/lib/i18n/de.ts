export const de = {
  ...
  preview: {
    title: "Korigio",
    intake: "Annahme starten",
    collapse: "Seitenleiste einklappen",
    home: "Start",
    customers: "Kunden",
    devices: "Geräte",
    repairs: "Reparaturen",
    diagnosis: "Diagnosevorlagen",
    companies: "Firmen",
    team: "Team",
    ...
    collected: "Eingenommene Schätzungen",
    themeToLight: "Helle Darstellung zeigen",
    themeToDark: "Dunkle Darstellung zeigen",
    statuses: {
      received: "Empfangen",
      diagnosis: "Diagnose",
      waitingCustomer: "Wartet auf Kunde",
      waitingPart: "Wartet auf Teil",
      inRepair: "In Reparatur",
      ready: "Bereit",
      awaitingPickup: "Abholbereit",
    },
  },
  notFound: {
